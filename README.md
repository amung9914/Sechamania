...
- 비밀번호는 회원가입 시 PBKDF2를 통한 암호화 후 저장
...
## 1. 비밀번호 암호화 방식 변경으로 시스템의 보안성 향상

### 변경 사항
비밀번호 암호화 방식을 Bcrypt에서 PBKDF2 방식으로 변경하였습니다.<br>
salt를 사용하는 PBKDF2알고리즘과 SHA-256해시 함수를 사용하여 보안성을 높였습니다.

### 이유  
1. 보안 강화 : PBKDF2는 더 안전한 해시 함수를 사용하여 암호를 보호합니다
2. 표준 알고리즘 : 미국NIST에서 승인받은 알고리즘인 PBKDF2는 일반적으로 사용되는 표준 알고리즘 중 하나입니다.
